...
import logo1 from "../assets/vybe.png"
      ...
      <div className='w-[90%] lg:max-w-[60%] h-[600px] bg-white rounded-2xl flex justify-center items-center overflow-hidden border-2 border-[#1a1f23]'>
        <div className='w-full lg:w-[50%] h-full bg-white flex flex-col items-center justify-center p-[10px] gap-[20px]'>
          ...
          <div className='relative flex items-center justify-start w-[90%] h-[50px] rounded-2xl border-2 border-black'
            ...
            ${inputClicked.userName ? "top-[-15px]" : ""}  `}> Enter Username </label>
          ...
          <div className='relative flex items-center justify-start w-[90%] h-[50px] rounded-2xl border-2 border-black'
            ...
            {!showPassword ? <IoMdEye className="absolute cursor-pointer right-[20px] w-[25px] h-[25px]"
              onClick={() => setShowPassword(true)} /> :

              <IoMdEyeOff className="absolute cursor-pointer right-[20px] w-[25px] h-[25px]"
