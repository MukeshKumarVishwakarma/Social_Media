    ...
    return (
        <div className='w-full max-w-[500px] h-[100vh] border-x-2 border-gray-800 pt-[10px] relative flex flex-col justify-center'>
            ...
            {!showViewers && <>
                ...
                {/* {storyData?.author?.userName == userData?.userName && <div
                className='w-full flex items-center h-[70px] gap-[10px] text-white absolute bottom-0 p-2 left-0'>
                ...
                {storyData?.author?.userName == userData?.userName && (
                    <div className="w-full flex items-center h-[70px] gap-[10px]
                     text-white absolute bottom-0 p-2 left-0 cursor-pointer"
            ...
            {showViewers && <>
                <div className='w-full h-[30%] flex items-center justify-center cursor-pointer mt-[100px] py-[30px] overflow-hidden'
                ...
                <div className='w-full h-[70%] border-t-2 border-t-gray-800 p-[20px]'>
                    <div className='text-white flex items-center gap-[10px]'> <FaEye />
